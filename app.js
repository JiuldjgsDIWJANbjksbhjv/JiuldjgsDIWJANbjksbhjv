...
clearFiltersBtn?.addEventListener("click", () => {
  ...
  document.getElementById("checkout-form")?.addEventListener("submit", (e) => {
    ...
    if (watchName) {
      // ── MODE INQUIRY (REQUEST INQUIRY bouton) ────────────────────────────
      // Message envoyé DEPUIS le WhatsApp du client VERS ton numéro
      // Format: Hello Dear MAGANTi, I'm [name] and asking for [watch] and my question is [message]
    ...
    // Ouvre WhatsApp du client avec ton numéro pré-rempli
...
window.openContactModal = function(pieceName) {
  ...
  // Store watch name for WhatsApp message
  if (checkoutModal) {
